 ...
 * @author IDC
 */
public class TabelBarangCari extends AbstractTableModel{
    ...
    public Object getValueAt(int i, int i1) {
        switch(i1){
            case 0 : return list.get(i).getKode();
            case 1 : return list.get(i).getNama_barang();
            case 2 : return list.get(i).getStok();
            case 3 : return list.get(i).getHarga_jual();
            case 4 : return list.get(i).getHarga_beli();
            default: return null;
        }
    }
